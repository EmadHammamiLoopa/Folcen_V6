  ...
  <ion-toolbar>
    ...
    <div class="user-info" (click)="showUserProfile()">
      <div class="avatar-wrapper">
        <img [src]="user?.getMainAvatar()" alt="Profile" *ngIf="user?.getMainAvatar()" />
        <div *ngIf="user?.online" class="online-dot"></div>
      </div>
    ...
    <ion-buttons slot="end">
      <ion-button *ngIf="!user?.isFriend && canRequestVideoCall()"
        ...
        <ion-icon [name]="activeVideoCall.status === 'accepted' ? 'videocam' : 'videocam-outline'"></ion-icon>
        <div *ngIf="activeVideoCall.status !== 'accepted'" class="request-badge">?</div>
      </ion-button>
