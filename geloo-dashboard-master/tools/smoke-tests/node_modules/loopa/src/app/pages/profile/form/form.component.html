...
<ion-content>
  <form class="p-2 ml-2" *ngIf="form" [formGroup]="form">
    ...
    <ion-list class="styled-list mx-3">
      ...
      <ion-item class="styled-item mt-3" (click)="presentLanguagesModal()">
        <ion-label position="floating">
          <i class="fas fa-language mr-2"></i>Languages
        </ion-label>
        <ion-input placeholder="Select languages you speak" type="text" [value]="selectedLanguages.join(', ')" readonly></ion-input>
      </ion-item>
      ...
      <ion-item class="styled-item mt-3">
        <ion-label>
          <i class="fas fa-lock mr-2"></i>Private Profile
        </ion-label>
