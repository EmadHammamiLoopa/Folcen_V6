...
<ion-content *ngIf="user && !pageLoading">
  ...
  <ion-list class="ion-no-margin ion-no-padding">
    ...
    <ion-item>
      <ion-label class="ml-2">
        <span class="d-block">Private Profile</span>
        <small class="d-block">Only followers can see your content</small>
      </ion-label>
      <ion-toggle [(ngModel)]="isPrivate" (ionChange)="togglePrivacy($event)"></ion-toggle>
    </ion-item>
  </ion-list>

  <div class="pt-2">
    <ion-text color="primary" class="ml-2">Display Settings</ion-text>
  </div>
  <ion-list class="ion-no-margin ion-no-padding">
    <ion-item>
      <ion-label class="ml-2">
        <span class="d-block">Light Mode</span>
        <small class="d-block">Switch to light theme</small>
      </ion-label>
      <ion-toggle [(ngModel)]="isLightMode" (ionChange)="toggleTheme($event)"></ion-toggle>
    </ion-item>
  </ion-list>
